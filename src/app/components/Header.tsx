      ...
      <body className={inter.className}>
        ...
        <header className="bg-gradient-to-r from-gray-900 to-gray-700 text-white p-4 shadow-xl">
          <nav className="container mx-auto flex justify-between items-center py-2">
            {/* Лого/Име на бранда */}
            <Link href="/" className="text-4xl font-extrabold text-transparent bg-clip-text bg-gradient-to-r from-blue-400 to-cyan-400 hover:from-blue-300 hover:to-cyan-300 transition duration-300 ease-in-out transform hover:scale-105 tracking-wider">
              Pamu3dkov
            </Link>
